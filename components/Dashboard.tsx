          ...
          <div className="absolute top-4 left-1/2 transform -translate-x-1/2 pointer-events-auto">
            <div className="bg-emerald-950/40 backdrop-blur-xl border border-emerald-500/20 rounded-full px-4 py-2 flex items-center gap-4">
              ...
              >
                ...
                <span className="text-sm text-emerald-400 font-medium">Follow</span>
              </div>
              ...
              <button
                ...
                className="flex items-center gap-2 text-sm text-emerald-400/80 hover:text-emerald-300 hover:bg-emerald-900/30 rounded-full px-3 py-1.5 transition-all duration-300"
              ...
              <button
                ...
                className="text-sm text-emerald-400/80 hover:text-emerald-300 hover:bg-emerald-900/30 rounded-full px-3 py-1.5 transition-all duration-300"
              >
                Settings
              </button>
